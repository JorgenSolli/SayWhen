<template>
    <div v-if="isSent" class="rounded-md shadow bg-green-50 p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-green-700">
                    <p>
                        Please check your email inbox and click the link in order to verify your email.
                    </p>

                    <button
                        v-if="isSent"
                        @click="send"
                        :class="{'opacity-70': loading, 'hover:bg-indigo-200': !loading}"
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700">
                    <p>
                        In order to receive notifications when your products are in stock, you need for first verify your email.
                    </p>
